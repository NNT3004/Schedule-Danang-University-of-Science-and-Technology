...
public class SchedulePanel extends JPanel{
    ...
    private void drawRoom(Graphics g, int index) {
        ...
        g.drawString("教室 " + rm.getName(), r.x + 3, r.y + h3 - 3);
        g.drawString("収容人数: " + rm.getSize(), r.x + 3, r.y + h3 * 2 - 3);
        g.drawString(rm.isLab() ? "PC有り" : "PC無し", r.x + 3, r.y + r.height - 3);
    }
    ...
    public SchedulePanel() {
        ...
        this.headerFont = new Font("ＭＳ ゴシック", Font.BOLD, 16);
        this.roomInforFont = new Font("ＭＳ ゴシック", Font.PLAIN, 10);
        this.classInforFont = new Font("ＭＳ ゴシック", Font.PLAIN, 10);
        this.criterInforFont = new Font("ＭＳ ゴシック", Font.BOLD, 10);
        this.days = new String[]{"月曜日", "火曜日", "水曜日", "木曜日", "金曜日", "土曜日"};
        this.hours = new String[]{"1限", "2限", "3限", "4限", "5限", "6限", "7限", "8限", "9限", "10限"};
